...
namespace TDPG.GeoCoordConversion
{
    ...
    {
        private static readonly double _NatGridScaleFactor = 0.9996012717; // NatGrid scale factor on central meridian
        private static readonly GridReference _NatNETrueOrigin = new GridReference(400000, -100000);
        private static readonly PolarGeoCoordinate _NatGridTrueOrigin = PolarGeoCoordinate.ChangeUnits(
            new PolarGeoCoordinate(49, -2, 0, AngleUnit.Degrees, CoordinateSystems.OSGB36),
            AngleUnit.Radians);

        private static readonly EllipseParameter _Airy1830 = EllipseParameter.GetEllipseParameters(EllipseParameter.Ellipses.Airy1830);
        private static readonly double _e2 = 1 - Math.Pow(_Airy1830.SemiMinorAxis, 2) / Math.Pow(_Airy1830.SemimajorAxis, 2);
        private static readonly double _n = (_Airy1830.SemimajorAxis - _Airy1830.SemiMinorAxis) / (_Airy1830.SemimajorAxis + _Airy1830.SemiMinorAxis);
